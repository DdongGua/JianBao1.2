...
public class Activity_Login extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        utils = ((MyAppalication)Activity_Login.this.getApplicationContext()).utils;
...
//                Intent intent = new Intent(getApplicationContext(), Activity_KeFu.class);
                        ...
                        try {
                            ...
                            if (! "200".equals(statusCode) ) {
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(Activity_Login.this, "账号密码错误", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            } else {
                                login();
                                ...
                                utils.saveShared("token",token,Activity_Login.this);
                                String token1 = utils.getShared("token", Activity_Login.this);
                                Log.e("token",token1);
                            }
