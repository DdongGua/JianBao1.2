...
public class Activity_PushGoods extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private ImageView cancel_tv;//取消按钮
    private ImageView mImg_bargain, mImg_brand, mImg_mianjiao;// 支持侃价,全新商品
...
//    private int flagThread = 0;                    //线程循环标记变量 否则会上个线程没执行完就进行下面的
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        token = shared.getShared("token", this);
        if (token == null || token == "") {
            Intent intent = new Intent(Activity_PushGoods.this, Activity_Login.class);
    ...
    private void initView() {
        cancel_tv = (ImageView) findViewById(R.id.cancel_tv);
        mImg_bargain = (ImageView) findViewById(R.id.mImg_bargain);
        mImg_brand = (ImageView) findViewById(R.id.mImg_brand);
        mImg_mianjiao = (ImageView) findViewById(R.id.mImg_mianjiao);
        ...
        mImg_mianjiao.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        switch (ID) {
            ...
            case R.id.mImg_bargain:
                if (flag) {
                    mImg_bargain.setImageResource(R.mipmap.publish_bargin_checked);
                } else {
                    mImg_bargain.setImageResource(R.mipmap.publish_bargin_inactive);
                }
                flag = !flag;
                break;
            case R.id.mImg_brand:
                if (flag1) {
                    mImg_brand.setImageResource(R.mipmap.publish_type_checked);
                } else {
                    mImg_brand.setImageResource(R.mipmap.publish_type_inactive);
                }
                flag1 = !flag1;
                break;
            case R.id.mImg_mianjiao:
                Toast.makeText(this, "此平台目前仅支持见面交易", Toast.LENGTH_SHORT).show();
                break;
...
//                }
                ...
                if (!isMobileNO(phone)|| "".equals(phone)) {
                    Toast.makeText(Activity_PushGoods.this, "手机号错误", Toast.LENGTH_SHORT).show();

                }
                if (title != null && !"".equals(title) && content != null && !"".equals(content)
                        && price != null && !"".equals(price) && isMobileNO(phone) && !"".equals(phone)) {
                    ok = new OkHttpClient();
                   ...
                   /* shared = new SharedUtils();
                    String token = shared.getShared("token",this);
*/
                    ...
                    ok.newCall(request).enqueue(new Callback() {
                        ...
                        public void onFailure(Call call, IOException e) {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    Toast.makeText(Activity_PushGoods.this, "发送失败", Toast.LENGTH_SHORT).show();
                                }
                            });
                        ...
                        public void onResponse(Call call, Response response) throws IOException {
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(Activity_PushGoods.this, "发送成功", Toast.LENGTH_SHORT).show();
                                    finish();
                                }
                            });
