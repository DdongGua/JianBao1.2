...
public class Activity_XinXi extends Activity implements View.OnClickListener {
    private TextView mTv_name, mTv_phone, mTv_gender, mTv_QQ, mTv_wechat, mTv_email, mTv_lasttime, mTv_isCode, mTv_code;
    private ImageView mTv_exit;
    private Map map = new HashMap();
    private SharedUtils utils;
    private String url = "http://192.168.4.188/Goods/app/user/info.json";
    private Info_xinxi info;
    ...
    private void initView() {
        mTv_exit = (ImageView) findViewById(R.id.mTv_exit);
        ...
        Info_xinxi info = (Info_xinxi) utils.getObject("info", this);
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (url.equals("http://192.168.4.188/Goods/app/user/info.json")) {
                    try {
                        ...
                        utils.saveObject("info",info,Activity_XinXi.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.mTv_exit:
                ...
                Info_xinxi info = null;
                utils.saveObject("info",info,Activity_XinXi.this);
                utils.saveBoolean("boolean",true,this);
                startActivity(new Intent(Activity_XinXi.this, Activity_Login.class));
                finish();
                break;
