...
public class PullToRefrushView extends ScrollView{
	...
	private int []drawables={R.mipmap.loading_01,R.mipmap.loading_02,R.mipmap.loading_03,R.mipmap.loading_04,
			R.mipmap.loading_05,R.mipmap.loading_06,R.mipmap.loading_07,R.mipmap.loading_08,R.mipmap.loading_09,
			R.mipmap.loading_10,R.mipmap.loading_11,R.mipmap.loading_12,};
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		if(ev.getAction()==MotionEvent.ACTION_DOWN){
			...
			select();
			if (mode==REFRASHING||mode==RELASE_LOAD||mode==RELASE_REFRASH){
				return true;
			}
		}
